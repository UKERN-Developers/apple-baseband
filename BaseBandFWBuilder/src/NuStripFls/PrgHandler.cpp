...
ulong32 PRGH_WriteElement(IFWD_MemoryStream *Output,ulong32 Type,ulong32 UID,char* PayloadPtr,ulong32 PayloadSize)
{
  ...
  int new_size = Output->Size + elem_size;
  int index =0;
  char* ElemStartMem;
  char* data_ptr=NULL;
...
bool swap_SecurityElementStructType_endian(SecurityElementStructType *I)
{
  ...
  swap_endian_long((char*)&I->Data.BootStartAddr,sizeof(I->Data.BootStartAddr));
  swap_endian_long((char*)&I->Data.BootLength,sizeof(I->Data.BootLength));
  swap_endian_long((char*)&I->Data.BootSignature,sizeof(I->Data.BootSignature));
...
bool swap_TocElementStructType_endian(TocElementStructType *I)
{
  ...
  {
    TocEntryStructType *T = I->Data.Data + (i * sizeof(TocEntryStructType));
